...
/** Achievement display info — used by both bot and mini-app */
export const ACHIEVEMENT_INFO: Record<AchievementType, { emoji: string; label: string; description: string }> = {
